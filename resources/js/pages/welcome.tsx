                ...
                <main className="main-content">
                    ...
                    <section className="plans-section modern" id="planes">
                        ...
                        <div className="plan-cards-container modern">
                            <div className="plan-card">
                                ...
                                <a href="#payment-basic" className="btn-secondary small">Seleccionar Plan</a>
                            </div>
                            <div className="plan-card popular">
                                ...
                                <a href="#payment-premium" className="btn-primary small">Seleccionar Plan</a>
                            </div>
                            <div className="plan-card">
                                ...
                                <a href="#payment-vip" className="btn-secondary small">Seleccionar Plan</a>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="newsletter-section" id="register">
                        <div className="content-wrapper">
                            ...
                            <form action="register.php" method="POST" className="contact-form">
