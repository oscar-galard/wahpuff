...
export default function VideoContent() {
    const { contents, noContentMessage } = usePage().props as { contents: Video[]; noContentMessage?: string };
                    ...
                    <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                            <div className="container mx-auto">
                                {noContentMessage ? (
                                    // Show the no content message if there are no videos
                                    <div className="text-center py-12">
                                        <h2 className="text-2xl font-bold text-gray-800 mb-4">Curso en Construcción</h2>
                                        <p className="text-lg text-gray-600">{noContentMessage}</p>
                                    </div>
                                ) : (
                                    <>
